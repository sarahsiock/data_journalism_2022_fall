...
**Answer** 
The table is no longer a list and shows 25 rows and four columns
```{r}
...
**Answer** The numbers are referring to the column positions.
...
**Answer** There are more than 20 LI tags. At the top it says there are 57 LI tags. 
...
**Answer** Now we can see the committee names starting around line 20. The committees are surrounded by other LI tags that are not committees. 
...
**Answer** This created a dataframe with 57 rows and 1 columns. The dataframe was stored as a variable called committees. However, there are rows that are not committees.
