...
**Answer**
I see a table with 365 rows and 10 columns. There are columns for precinct_ID, precinct_Names, CONGRESS, LEGIS, COUNCIL, SCHOOL, POLLING_ID, Shape_Length, Shape_Area, Shape. 
...
**Answer** This chart contains the shape length, shape area and shape for every precinct. 
...
**Answer** This is a map of all of the precincts in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is a code for the library tigris so we are able to use the counties() functions to pull down a shapfile of all the U.S. counties. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This code block displays a table with 18 columns and 3,234 rows. It also contains all of the U.S. counties for 2020. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This table contains the shape Mmltipolygon as well as longitude and latitude. The names of counties and geoid are also included.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**This is a map of Maryland with the counties outlined.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This is a map of Prince George's county with the precincts identified. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** 
This table shows the total votes, early voting, total absentee, total provisional and total eligible for Prince George's County.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Now there is a joined table that contains the precinct shapes with voter turnout. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This is a map of all of the precincts in Maryland and the number of total eligible voters. The darker colors represent areas with fewer eligible voters. The blank spots are ghost counties. 
```{r}
ggplot() +
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table with all of the eligble voters for each county in Maryland as well as their regisered parties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table with the estimated population for every county with a blank MOE column.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**A table with every county's population. There is also a column for geometry. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This voters by county table which includes a party breakdown.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table that shows county, population and geometry. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A joined table with county and total eligible voters for each county. There is also a geometry column. However, there are columns with NAs.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The NA column for St. Mary's and Baltimore County are now gone. These counties were originally spelled differently on each table but we were able to use mutate to make them the same.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This table displays eligible voters per 10k people in each county. Worcester is at the top.
```{r}
md_voters_per_10k <- md_county_population %>%
  left_join(voters_by_county) %>%
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A map of Maryland voters perk 10k people. The counties with more voters are shaded darker.
```{r}
ggplot() +
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Now the colors are more defined and you can clearly see which counties have the most voters.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** 
Noew there is a column for unaffialited voters per 10k people.
```{r}
...
**Answer** 
It appears at the bottom of the state many of the counties have a smaller number of unaffiliated voters (Somerset, Wicomico, and Worcester). Prince George's county also has a low concentration of unaffiliated voters, unlike the other counties that surround it. 
```{r}
ggplot() +
