...
https://datawrapper.dwcdn.net/8nZSC/1/
...
md_gov_county <- md_gov_county %>% mutate(total_votes = Cox + Moore + Lashar + Wallace + Harding)
md_gov_county <- md_gov_county %>% mutate(perc_Moore = (Moore)/(total_votes)*100)
...
It is no longer the whole country and just a map of Maryland.
...
**Answer** Describe the changes from the previous map
Now the percents are exact numbers, and we can see the name of the counties instead of just a number. 
...
https://datawrapper.dwcdn.net/6OFrR/1/
