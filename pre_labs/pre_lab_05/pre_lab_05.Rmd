...
**Answer**There are a few of the same restaurants spelled different ways. For example,"W. MILLAR & CO"and "W. MILLAR & CO." with a "." 
...
**Answer**
1.) LE DIPLOMATE, LE DIPLOMATE changed to LE DIPLOMATE
2.)JOE'S SEAFOOD PRIME STEAK & STONE CRAB	changes to JOE'S SEAFOOD, PRIME STEAK & STONE CRAB with a ",".
...
**Answer**
1.) W. MILLAR & CO now has a . both times.
2.) We, the Pizza no longer has a ",".
3.)WALTER'S SPORTS BAR to WALTERS SPORTS BAR
```{r}
cleaned_dc_food %>%
...
**Task** Run the following code to use the n_gram_merge() function to clean the data, then group by city_clean and city to examine cities that start with W. Look at the differences. Does the changes it made vary substantially from the previous use of key_collision_merge?
**Answer**I do not see a substantial change. W. MILLAR & CO has a . both times and We, the Pizza no longer has a ",". WALTERS SPORTS BAR also was changed without a " ' ".
